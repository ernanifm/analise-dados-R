...
# sumarizando os dados com as médias de cada coluna de um dataset.
library(dplyr)
...
# Extraindo o valor inteiro de uma das colunas decimais.
library(data.table)
...
# Construindo um gráfico mostrando a relação de duas variáveis numéricas para as 3 categorias de uma variável categórica.
library(ggplot2)
